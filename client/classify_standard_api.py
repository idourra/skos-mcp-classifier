...
def get_context(concept_uri: str, taxonomy_id: str = None):
    """Get context for a SKOS concept using the MCP server"""
    payload = {"concept_uri": concept_uri}
...
def classify(text: str, product_id: str = None, taxonomy_id: str = None):
    ...
    Args:
        ...
        taxonomy_id (str, optional): ID of specific taxonomy to use (uses default if None)
    ...
    functions = [
        {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "taxonomy_id": {
                        "type": "string",
                        "description": "ID of specific taxonomy to use (optional)"
                    }
                },
                "required": ["query"]
            }
    ...
    while response.choices[0].message.function_call:
        ...
        if function_name == "search_concepts":
            # Add taxonomy_id if provided and not already in function args
